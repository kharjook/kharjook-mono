...
export const CURRENCY_META: Record<Currency, CurrencyMeta> = {
  ...
  USDT: { code: 'USDT', label: 'تتر', symbol: '₮', decimals: 4 },
...
export const CURRENCY_ORDER: Currency[] = ['IRT', 'USD', 'USDT', 'TRY', 'EUR'];

/** Display order for currencies that have a toman_per_unit rate (excludes IRT). */
export const RATE_ORDER: RateCurrency[] = ['USD', 'USDT', 'TRY', 'EUR'];
